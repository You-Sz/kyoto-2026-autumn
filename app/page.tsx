const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["15:30", "錦市場", "趁多數攤商收店前逛市場、少量品嘗小吃；購買後請在店前或店內食用。"],
      ["17:15", "四條河原町購物", "大丸京都、新京極、寺町京極、京都高島屋 S.C. 與 T8；時間不足時以高島屋 S.C. 為主。"],
      ["19:00", "いろは北店・壽喜燒晚餐", "前往先斗町的 Iroha 北店享用京都風壽喜燒；由高島屋 S.C. 步行約 5 分鐘，務必事先預約。"],
    ],
  ...
  },
  {
    ...
    date: "10.11",
    weekday: "SUN",
    title: "清水寺・二三年坂・祇園・美髮沙龍",
    tone: "temple",
    events: [
      ["09:00", "京都站出發・搭 206 公車", "由京都站前搭市營巴士 206 系統，在東山七條站下車；週日可能塞車，預留候車與行車時間。"],
      ["09:25", "東山七條站・步行清水坂", "下車後往清水寺方向步行約 25–30 分鐘；沿途為上坡，穿好走的鞋。"],
      ["10:00", "清水寺", "參觀清水舞台、主要伽藍與音羽瀑布，停留約 75–90 分鐘。"],
      ["11:30", "產寧坂・三年坂・二年坂", "由清水寺一路下坡散步，逛老街、伴手禮店；產寧坂即常稱的三年坂。"],
      ["12:10", "八坂庚申堂", "欣賞色彩鮮明的庚申吊飾，簡短參拜拍照。"],
      ["12:30", "八坂通拍八坂塔", "由八坂通取景法觀寺五重塔；拍照後在東山一帶安排午餐。"],
      ["13:30", "八坂神社", "經寧寧之道或高台寺周邊前往八坂神社參拜。"],
      ["14:00", "祇園散步", "走花見小路、四條通與白川一帶；約 14:45 準備前往餐廳，不再趕往東福寺。"],
      ["15:00", "祇園・河原町提早晚餐", "在祇園四條、先斗町或三條周邊用餐，控制在約 60 分鐘，預留前往美髮沙龍的時間。"],
      ["16:30", "NOBOL Hair Salon & Spa・燙髮", "位於二條木屋町、提供英文協助；一般燙加剪髮最晚 16:30 報到，務必事先網路預約並附上理想髮型照片。"],
      ["18:30", "完成燙髮・返回京都站", "可由京都市役所前搭地下鐵至烏丸御池轉烏丸線，或直接搭計程車返回 Hotel Vischio Kyoto。"],
    ],
    alert: "預約提醒｜NOBOL 週日營業至 18:30，剪髮＋一般燙最晚 16:30、單做燙髮最晚 17:00。若選數位燙或複雜造型，建議預約 15:30，並將晚餐改到燙髮完成後。",
  },
  {
    id: "day-5",
    date: "10.12",
...
const links = [
  ...
  ["NOBOL 美髮沙龍", "https://nobol-hair.com/"],
];
