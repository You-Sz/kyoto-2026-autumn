const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["14:00", "祇園散步", "走花見小路、四條通一帶，最晚 14:30 前往祇園四條站。"],
      ["14:35", "祇園四條站 → 東福寺站", "搭京阪本線普通或準急直達東福寺站，車程約 10 分鐘；不要搭不停東福寺的特急。"],
      ["15:00", "東福寺", "由車站步行約 10 分鐘，參觀通天橋、方丈庭園與臥雲橋；務必在最後入場前抵達。"],
    ],
    alert: "硬截止｜東福寺秋季通常約 16:00 停止入場，祇園最晚 14:30 離開。206 公車遇塞車超過 20 分鐘時，應縮短清水寺或祇園停留時間。",
  },
  {
    id: "day-5",
    date: "10.12",
