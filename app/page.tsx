const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["15:15", "錦市場", "趁多數攤商收店前快速逛市場、少量品嘗小吃；15:45 左右步行前往弗朗索瓦喫茶室。"],
      ["16:00", "弗朗索瓦喫茶室", "前往四條河原町的老字號西洋風喫茶室喝咖啡、吃甜點；不接受訂位且只收現金。若排隊太久就改外帶或省略，以免錯過導覽。"],
      ["16:50", "前往導覽集合處", "由喫茶室前往「京都河原町花園角落」，建議提早抵達並確認 Klook 憑證與導遊辨識方式。"],
      ["17:20", "Klook 祇園夜間導覽", "依預約時間集合出發，跟隨導遊夜遊祇園一帶；穿著適合長時間步行的鞋。"],
      ["20:20", "三條大橋・導覽結束", "預計在三條大橋解散，接著沿河原町通往四條方向步行。"],
      ["20:35", "唐吉訶德四條河原町店", "從三條大橋步行約 10–15 分鐘，安排約 60–75 分鐘購物；若尚未吃晚餐，可先在河原町附近簡單用餐。"],
      ["22:00", "返回京都站・飯店", "購物後由四條河原町搭公車或計程車返回 Hotel Vischio Kyoto。"],
    ],
    note: "前一天已在傘松公園看昇龍觀，View Land只是另一個飛龍觀角度；若想多泡湯或避免壓縮下午行程就直接省略。17:20 導覽為固定集合時間，最優先保留。",
  },
  {
    id: "day-4",
    date: "10.11",
    ...
    events: [
      ...
      ["08:00", "京都站出發・搭 206 公車", "由京都站前搭市營巴士 206 系統，在東山七條站下車；週日可能候車或塞車，班次時間保留彈性。"],
      ["08:25", "東山七條站・步行清水坂", "下車後往清水寺方向步行約 25–30 分鐘；沿途為上坡，穿好走的鞋。"],
      ["09:00", "清水寺", "趁上午人潮較少參觀清水舞台、主要伽藍與音羽瀑布，停留約 90 分鐘。"],
      ["10:30", "GOKAGO 抹茶", "配合開門時間前往清水坂上的日本茶專門店；不接受預約，預留約 30–45 分鐘含排隊。"],
      ["11:15", "產寧坂・三年坂・二年坂", "一路下坡散步，逛老街與伴手禮店；產寧坂即常稱的三年坂。"],
      ["12:15", "八坂庚申堂", "欣賞色彩鮮明的庚申吊飾，簡短參拜拍照。"],
      ["12:35", "八坂通拍八坂塔・午餐", "由八坂通取景法觀寺五重塔，拍照後在東山一帶安排午餐。"],
      ["14:00", "八坂神社", "經寧寧之道或高台寺周邊前往八坂神社參拜。"],
      ["14:30", "祇園散步", "走花見小路、四條通與白川一帶，約 15:15 往四條河原町移動。"],
      ["15:20", "四條河原町百貨購物", "逛京都高島屋 S.C.、T8 或河原町周邊商店；時間有限，建議鎖定一間百貨，並在 16:35 前結帳離開。"],
      ["16:40", "前往先斗町", "由四條河原町步行前往先斗町的いろは北店，提早抵達辦理入店。"],
      ["17:00", "いろは北店・壽喜燒晚餐", "悠閒享用京都風壽喜燒，不必趕下一個預約行程。"],
      ["19:00", "返回京都站", "晚餐後由河原町搭公車、地下鐵或計程車返回京都站，依實際用餐結束時間調整。"],
      ["19:30", "京都站夜間行程・三選一", "① AEON Mall Kyoto 逛街；② Kyoto Station Skyway 散步看夜景；③ 京都塔觀景台。若想輕鬆且免費，優先選 Skyway；出發前再確認各設施當日營業時間與最晚入場。"],
      ["21:00", "返回飯店", "步行返回 Hotel Vischio Kyoto，整理隔天回程行李並早點休息。"],
    ],
    note: "四條河原町購物已由 10/10 移到本日下午。晚餐後的京都站夜間行程三選一即可；隔天需早起搭 HARUKA，建議 21:00 左右回飯店。",
  },
  {
    id: "day-5",
    date: "10.12",
...
const links = [
  ...
  ["唐吉訶德四條河原町店", "https://www.donki.com/store/shop_detail.php?shop_id=612"],
      ...
      <section className="checklist" id="checklist">
        <div className="shell checklist-inner">
          ...
          <div className="check-grid">
            <div><b>01</b><h3>交通・預約憑證</h3><p>京都往返天橋立指定席、10/12 第一班 HARUKA、10/10 Klook 祇園夜間導覽憑證。</p></div>
