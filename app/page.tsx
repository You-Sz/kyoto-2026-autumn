const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["14:00", "祇園慢慢逛", "走花見小路、四條通與白川一帶，可安排咖啡休息或小店購物，停留到約 16:20。"],
      ["16:20", "祇園 → 京都站", "搭計程車返回京都站八條口最省力；遇週日塞車時提早離開，確保晚餐與 teamLab 不延誤。"],
      ["17:00", "京都站・八條口晚餐", "在京都站、Porta 或八條口一帶用餐，約 18:15 前結束；避免選需要長時間排隊的餐廳。"],
      ["18:35", "步行前往 teamLab", "從京都站八條東口步行約 7 分鐘，提早抵達並準備手機 QR 票券。"],
    ...
    alert: "預約提醒｜teamLab 採指定日期與時段入場，請預先購買 10/11 19:00 票券。場館 21:00 關閉、最晚 19:30 入場；19:00 抵達可保留約兩小時參觀。",
  },
  {
    id: "day-5",
    date: "10.12",
