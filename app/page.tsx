const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["14:00", "祇園散步", "慢慢走花見小路、四條通與白川一帶，不再趕往東福寺。"],
      ["16:00", "祇園・河原町提早晚餐", "在祇園四條、先斗町或三條周邊用餐，控制在約 60 分鐘，預留前往美髮沙龍的時間。"],
      ["17:30", "box kyoto 美髮沙龍", "京都市役所前站 11 號出口步行 1 分鐘；提供英文協助，適合洗剪、護髮或造型，務必事先網路預約。"],
      ["19:00", "返回京都站・飯店", "由京都市役所前搭地下鐵至烏丸御池轉烏丸線，或直接搭計程車返回 Hotel Vischio Kyoto。"],
    ],
    alert: "預約提醒｜box kyoto 週日營業至 19:00；17:30 適合洗剪、護髮或造型。若要染髮、燙髮或縮毛矯正，應改約 15:30–16:00，晚餐移到做完頭髮之後。",
  },
  {
    id: "day-5",
    date: "10.12",
...
const links = [
  ...
  ["box kyoto 美髮沙龍", "https://boxkyoto.com/en/"],
];
