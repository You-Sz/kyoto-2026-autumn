const days = [
  ...
  },
  {
    ...
    events: [
      ...
      ["16:00", "弗朗索瓦喫茶室", "前往四條河原町的老字號西洋風喫茶室喝咖啡、吃甜點；不接受訂位且只收現金，客滿時需現場排隊。"],
      ["17:15", "四條河原町購物", "大丸京都、新京極、寺町京極、京都高島屋 S.C. 與 T8；時間不足時以高島屋 S.C. 為主。"],
      ["19:00", "四條河原町自由晚餐", "依當天購物進度在河原町、錦小路或四條烏丸周邊用餐；不安排需長時間候位的名店。"],
    ],
  ...
  },
  {
    ...
    events: [
      ...
      ["11:30", "GOKAGO 抹茶", "清水寺參觀後前往清水坂上的日本茶專門店；10:30 開門、不接受預約，預留約 30 分鐘含排隊。"],
      ["12:00", "產寧坂・三年坂・二年坂", "一路下坡散步，逛老街與伴手禮店；產寧坂即常稱的三年坂。"],
      ["12:40", "八坂庚申堂", "欣賞色彩鮮明的庚申吊飾，簡短參拜拍照。"],
      ["13:00", "八坂通拍八坂塔・午餐", "由八坂通取景法觀寺五重塔，拍照後在東山一帶安排午餐。"],
      ["14:15", "八坂神社", "經寧寧之道或高台寺周邊前往八坂神社參拜。"],
      ["14:45", "祇園慢慢逛", "走花見小路、四條通與白川一帶，可安排小店購物，停留到約 16:20。"],
